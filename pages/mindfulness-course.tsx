...
const sections: { [key: string]: Section } = {
  "Mindfulness": {
    ...
    text: `
      ...
      <p>&emsp;Have you ever felt stressed before? I’ll start off like this. It may seem somewhat of an off-putting or obvious question, but it is really genuine. All of us have felt stressed in one way or another, and we can all remember the times we have. But have we ever gotten genuinely curious as to why there is stress? </p>
      <p>&emsp;This is why I started meditating, because, quite frankly, I didn’t like stress. I wanted to be happy, or at least avoid total misery. I find this is also why many others come to meditation. Sometimes people will get curious as I did, and ask me how they could incorporate meditation into their lives. It makes sense, because there is a lot of pressure in this society, homework assignments to finish, conflicts among friends, uncertainty about where our life is going, and worrying about what others think of us. So people come to meditation for the same reason I did - to be happy and more comfortable in their daily lives. Someone once asked me if meditation can help you laugh. That question made me laugh, because it was real. Meditation does help us be less afraid, because when we are fully in the moment, we’ll see that there isn’t any problem at all. It’s just Now, what else could we need :)</p>
<p>&emsp;People who I guide meditation through are often concerned if they are doing it “right.”  But there is no right or wrong as long as you are consistently returning your attention back to the present moment. That’s all there is to it. It’s wonderfully simple… but people like to make things so complicated. Many people have never experienced the simple joy of being present. I find it a bit sad, because it has been the case many times that only when someone has learned they are about to die, that they begin to realize what is truly important in this age of distraction. They begin to slow down and notice the little things. The tree outside, the feel of the sun on their skin, the cool breeze, the breath. There is a gratitude that comes because of this presence. I don’t want to wait until that time, I’m the type that likes to start things early. I’d like to start living now. </p>
<br>
